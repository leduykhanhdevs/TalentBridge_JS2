...
class AuthControllerTest {
    ...
    @Test
    @DisplayName("POST /api/v1/auth/login - Email không tồn tại và sai mật khẩu trả cùng lỗi chung")
    void testLoginDoesNotRevealWhetherAccountExists() throws Exception {
        RegisterRequest registerReq = RegisterRequest.builder()

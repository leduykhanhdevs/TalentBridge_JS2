                        ...
                        <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-5">
                            ...
                            <div>
                                <h3 className="font-bold text-amber-900">
                                    Doanh nghiệp đang chờ Quản trị viên (Admin) xét duyệt
                                </h3>
                                <p className="mt-1 text-sm text-amber-700">
                                    Hồ sơ đăng ký doanh nghiệp của bạn đang trong hàng đợi phê duyệt. Sau khi Admin kích hoạt, bạn sẽ có toàn quyền đăng tin tuyển dụng và phê duyệt các HR khác vào công ty.
                                </p>
                            </div>
                        </div>
                    )}
